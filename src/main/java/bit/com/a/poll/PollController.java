...
public class PollController {
	...
	public String polldetail(Model model, PollDto poll) {
		model.addAttribute("doc_title", "투표글 상세보기");
		PollDto polls = service.getPoll(poll);
		List<PollSubDto> pollsub = service.getPollSubList(polls);
		model.addAttribute("poll", polls);
		model.addAttribute("pollsublist", pollsub);
